...
Exp3=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $3}')
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/freetunnel/iz/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/freetunnel/hpx/main/"
start=$(date +%s)
secs_to_human() {
...
wget https://raw.githubusercontent.com/freetunnel/hpx/main/Fls/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
<code>────────────────────</code>
<i>Automatic Notification Installer</i>
<i>Installing Script Haproxy New</i>
...
wget raw.githubusercontent.com/freetunnel/hpx/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /usr/bin/ws "https://raw.githubusercontent.com/freetunnel/hpx/main/Fls/ws" >/dev/null 2>&1
wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/freetunnel/hpx/main/Cfg/tun.conf" >/dev/null 2>&1
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/freetunnel/hpx/main/Fls/ws.service" >/dev/null 2>&1
