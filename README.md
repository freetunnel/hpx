...
### PERINTAH UPDATE 
<pre><code>if [[ ! -d /etc/xdtmp ]]; then mkdir -p /etc/xdtmp; fi && wget -q https://raw.githubusercontent.com/freetunnel/hpx/main/update.sh && chmod +x update.sh && ./update.sh</code></pre>
